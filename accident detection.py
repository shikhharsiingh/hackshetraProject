...
while res:
    ...
    if flag == 1:
        ...
        frame = cv2.putText(frame, "28° 35' 31.7040'' N and 77° 2' 45.7836'' E. ; ", (40, 80), font, fontScale, color, thickness, cv2.LINE_AA, False)
        frame = cv2.putText(frame, "time:1600 hrs; ", (40, 100), font, fontScale, color, thickness, cv2.LINE_AA, False)
        frame = cv2.putText(frame, "camera id:DWARKA_ROAD_22", (40, 120), font, fontScale, color, thickness, cv2.LINE_AA, False)
